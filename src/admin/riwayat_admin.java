...
public class riwayat_admin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(300, 190, 520, 360);
        ...
        jPanel2.add(txtcari);
        txtcari.setBounds(530, 140, 260, 30);
        ...
        jPanel2.add(jLabel7);
        jLabel7.setBounds(790, 140, 30, 30);
        ...
        btn_deleteall.setBackground(new java.awt.Color(255, 255, 255));
        btn_deleteall.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btn_deleteall.setForeground(new java.awt.Color(36, 36, 36));
        btn_deleteall.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/trashred_25px.png"))); // NOI18N
        btn_deleteall.setText("Hapus Semua");
        btn_deleteall.setBorder(null);
        btn_deleteall.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btn_deleteall.setOpaque(false);
        btn_deleteall.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                btn_deleteallFocusGained(evt);
            }
        });
        ...
        btn_deleteall.setBounds(370, 140, 140, 30);
    ...
    private void btn_deleteallActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_deleteallActionPerformed
        // TODO add your handling code here:
        int response = JOptionPane.showConfirmDialog(this, "Apakah anda yakin ingin Menghapus semua Riwayat?", "Konfirmasi Hapus", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        if (response == JOptionPane.YES_OPTION) {

            try {
                String sql ="delete from tranksaksi ;";
                java.sql.Connection conn=(Connection)Config.configDB();
                java.sql.PreparedStatement pst=conn.prepareStatement(sql);
                pst.execute();
                JOptionPane.showMessageDialog(this, "Semua Riwayat berhasil di hapus");
            } catch (Exception e) {
                JOptionPane.showMessageDialog(this, e.getMessage());
            }
            load_table();
    ...
    private void btn_deleteallFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_btn_deleteallFocusGained
        // TODO add your handling code here:
    }//GEN-LAST:event_btn_deleteallFocusGained
...
private void load_table1() {
    ...
    try {
        int no=1;
        String sql = "SELECT barang.nama_barang, detail_tranksaksi.qty, detail_tranksaksi.harga_total from ((detail_tranksaksi inner join tranksaksi on detail_tranksaksi.id_tranksaksi=tranksaksi.id_tranksaksi) "
